...
const Sidebar = ({ isDarkMode }: SidebarProps) => {
    ...
    return (
        <aside className={`flex flex-col min-h-screen p-6 transition-all duration-500 ${
            isDarkMode
            ...
            <div className="flex items-center justify-center mb-10">
                ...
                <h2 className={`text-3xl font-extrabold ml-4 ${isDarkMode ? "text-white" : "text-gray-900"} transition-colors duration-300`}>
                    DashPro
                </h2>
            </div>
